...
def get_argparse():
    ...
    model_g.add_arg("dump_result", default=True, type=bool, help="")
    ...
    model_g.add_arg("per_gpu_eval_batch_size", default=4, type=int, help="Batch size per GPU/CPU for evaluation.")
    ...
    model_g.add_arg("overwrite_cache", type=bool, default=True, help="Overwrite the cached training and evaluation sets")
